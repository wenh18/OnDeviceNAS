...
```python
import mytimm
model = mytimm.create_model('seresnet152d', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('seresnet152d', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: seresnet152d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/a7f95818e44b281137503bcf4b3e3e94d8ffa52f/mytimm/models/resnet.py#L1206
...
- Name: seresnet50
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/a7f95818e44b281137503bcf4b3e3e94d8ffa52f/mytimm/models/resnet.py#L1180
