...
```python
import mytimm
model = mytimm.create_model('mixnet_l', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('mixnet_l', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: mixnet_l
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1669
...
- Name: mixnet_m
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1660
...
- Name: mixnet_s
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1651
...
- Name: mixnet_xl
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1678
