...
```python
import mytimm
model = mytimm.create_model('cspdarknet53', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('cspdarknet53', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: cspdarknet53
  ...
  Metadata:
    ...
    FPS (GPU RTX 2070): 66
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/cspnet.py#L441
