...
```python
import mytimm
model = mytimm.create_model('tf_mixnet_l', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('tf_mixnet_l', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: tf_mixnet_l
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1720
...
- Name: tf_mixnet_m
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1709
...
- Name: tf_mixnet_s
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1698
