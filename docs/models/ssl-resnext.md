...
```python
import mytimm
model = mytimm.create_model('ssl_resnext101_32x16d', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('ssl_resnext101_32x16d', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: ssl_resnext101_32x16d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L944
...
- Name: ssl_resnext101_32x4d
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L924
...
- Name: ssl_resnext101_32x8d
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L934
...
- Name: ssl_resnext50_32x4d
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L914
