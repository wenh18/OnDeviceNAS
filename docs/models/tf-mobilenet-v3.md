...
```python
import mytimm
model = mytimm.create_model('tf_mobilenetv3_large_075', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('tf_mobilenetv3_large_075', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: tf_mobilenetv3_large_075
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L394
...
- Name: tf_mobilenetv3_large_100
  ...
  Metadata:
    ...
    Weight Decay: 1.0e-05
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L403
...
- Name: tf_mobilenetv3_large_minimal_100
  ...
  Metadata:
    ...
    Weight Decay: 1.0e-05
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L412
...
- Name: tf_mobilenetv3_small_075
  ...
  Metadata:
    ...
    Interpolation: bilinear
    RMSProp Decay: 0.9
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L421
...
- Name: tf_mobilenetv3_small_100
  ...
  Metadata:
    ...
    Interpolation: bilinear
    RMSProp Decay: 0.9
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L430
...
- Name: tf_mobilenetv3_small_minimal_100
  ...
  Metadata:
    ...
    Interpolation: bilinear
    RMSProp Decay: 0.9
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L439
