...
```python
import mytimm
model = mytimm.create_model('efficientnet_b1_pruned', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('efficientnet_b1_pruned', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: efficientnet_b1_pruned
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/a7f95818e44b281137503bcf4b3e3e94d8ffa52f/mytimm/models/efficientnet.py#L1208
...
- Name: efficientnet_b2_pruned
  ...
  Metadata:
    ...
    Image Size: '260'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/a7f95818e44b281137503bcf4b3e3e94d8ffa52f/mytimm/models/efficientnet.py#L1219
...
- Name: efficientnet_b3_pruned
  ...
  Metadata:
    ...
    Image Size: '300'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/a7f95818e44b281137503bcf4b3e3e94d8ffa52f/mytimm/models/efficientnet.py#L1230
