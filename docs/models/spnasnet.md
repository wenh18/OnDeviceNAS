...
```python
import mytimm
model = mytimm.create_model('spnasnet_100', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('spnasnet_100', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: spnasnet_100
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L995
