...
```python
import mytimm
model = mytimm.create_model('tf_efficientnet_cc_b0_4e', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('tf_efficientnet_cc_b0_4e', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: tf_efficientnet_cc_b0_4e
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1561
...
- Name: tf_efficientnet_cc_b0_8e
  ...
  Metadata:
    ...
    Label Smoothing: 0.1
    BatchNorm Momentum: 0.99
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1572
...
- Name: tf_efficientnet_cc_b1_8e
  ...
  Metadata:
    ...
    Label Smoothing: 0.1
    BatchNorm Momentum: 0.99
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/efficientnet.py#L1584
