...
```python
import mytimm
model = mytimm.create_model('ens_adv_inception_resnet_v2', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('ens_adv_inception_resnet_v2', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: ens_adv_inception_resnet_v2
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/inception_resnet_v2.py#L351
