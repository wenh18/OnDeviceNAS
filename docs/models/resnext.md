...
```python
import mytimm
model = mytimm.create_model('resnext101_32x8d', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('resnext101_32x8d', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: resnext101_32x8d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/b9843f954b0457af2db4f9dea41a8538f51f5d78/mytimm/models/resnet.py#L877
...
- Name: resnext50_32x4d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/b9843f954b0457af2db4f9dea41a8538f51f5d78/mytimm/models/resnet.py#L851
...
- Name: resnext50d_32x4d
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/b9843f954b0457af2db4f9dea41a8538f51f5d78/mytimm/models/resnet.py#L869
...
- Name: tv_resnext50_32x4d
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L842
