...
```python
import mytimm
model = mytimm.create_model('ig_resnext101_32x16d', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('ig_resnext101_32x16d', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: ig_resnext101_32x16d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/resnet.py#L874
...
- Name: ig_resnext101_32x32d
  ...
  Metadata:
    ...
    Interpolation: bilinear
    Minibatch Size: 8064
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/resnet.py#L885
...
- Name: ig_resnext101_32x48d
  ...
  Metadata:
    ...
    Weight Decay: 0.001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/resnet.py#L896
...
- Name: ig_resnext101_32x8d
  ...
  Metadata:
    ...
    Weight Decay: 0.001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/resnet.py#L863
