...
```python
import mytimm
model = mytimm.create_model('res2net101_26w_4s', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('res2net101_26w_4s', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: res2net101_26w_4s
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L152
...
- Name: res2net50_14w_8s
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L196
...
- Name: res2net50_26w_4s
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L141
...
- Name: res2net50_26w_6s
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L163
...
- Name: res2net50_26w_8s
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L174
...
- Name: res2net50_48w_2s
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/res2net.py#L185
