...
```python
import mytimm
model = mytimm.create_model('swsl_resnet18', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('swsl_resnet18', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: swsl_resnet18
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L954
...
- Name: swsl_resnet50
  ...
  Metadata:
    ...
    Weight Decay: 0.0001
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/resnet.py#L965
