...
```python
import mytimm
model = mytimm.create_model('legacy_seresnext101_32x4d', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('legacy_seresnext101_32x4d', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: legacy_seresnext101_32x4d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/senet.py#L462
...
- Name: legacy_seresnext26_32x4d
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/senet.py#L448
...
- Name: legacy_seresnext50_32x4d
  ...
  Metadata:
    ...
    Image Size: '224'
    Interpolation: bilinear
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/senet.py#L455
