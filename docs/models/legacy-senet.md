...
```python
import mytimm
model = mytimm.create_model('legacy_senet154', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('legacy_senet154', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: legacy_senet154
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/d8e69206be253892b2956341fea09fdebfaae4e3/mytimm/models/senet.py#L440
