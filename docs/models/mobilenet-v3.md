...
```python
import mytimm
model = mytimm.create_model('mobilenetv3_large_100', pretrained=True)
model.eval()
```
...
```python
model = mytimm.create_model('mobilenetv3_large_100', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: mobilenetv3_large_100
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L363
...
- Name: mobilenetv3_rw
  ...
  Metadata:
    ...
    Weight Decay: 1.0e-05
    Interpolation: bicubic
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/mytimm/models/mobilenetv3.py#L384
