...
An inference and train step benchmark script for mytimm models.
...
from mytimm.models import create_model, is_model, list_models
from mytimm.optim import create_optimizer_v2
from mytimm.data import resolve_data_config
from mytimm.utils import setup_default_logging, set_jit_fuser
